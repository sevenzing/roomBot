...
from roomBot import database, timetools, config, tools, telegramtools
...
def check_time(bot, db):
    ...
    for chat in database.find_chats_with_notice():
        ...
        if current_building == chat['chosenbuilding']:
            ...
            database.update(chat_id, lastnotice=lastnotice.__repr__())
